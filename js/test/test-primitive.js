(function(){
	require(['ivy', 'ivy-line', 'ivy-arc', 'ivy-bezier', 'ivy-quadratic', 'ivy-oval'], 
			function(Ivy, IvyLine, IvyArc, IvyBezier, IvyQuadratic, IvyOval){
